...
for i in range(len(sub_list)):
    ...
    os.makedirs(subj_fields_dir +"/%s_SimNIBS_e_fields_Fp1_OFC" % (sub))
    ...
    #O/P folder
    s.pathfem = subj_fields_dir +"/%s_SimNIBS_e_fields_Fp1_OFC/" % (sub)
# -----------------------------------------------------------------------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------------------------------------------------------------------
    ...
    pos.pos_ydir = 'AF7' #AF3
# -----------------------------------------------------------------------------------------------------------------------------------------
#     # Add another position
#     pos_superior = tmslist.add_position()
#     # Centred at F1
#     pos_superior.centre = 'Fp1'
#     # Pointing towards Fz
#     pos_superior.pos_ydir = 'Fpz' #Fpz
